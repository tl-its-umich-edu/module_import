...
DATABASES = {
    'default': {
        ...
        'NAME': config('MYSQL_DATABASE', 'module_import_local'),
        'USER': config('MYSQL_USER', 'module_import_user'),
        'PASSWORD': config('MYSQL_PASSWORD', 'module_import_pwd'),
        'HOST': config('MYSQL_HOST', 'module_import_mysql_host'), 
...
CACHES = {
    "default": {
        ...
        "LOCATION": config('REDIS_LOCATION', "redis://module_import_redis_host:6379")
    }
}
